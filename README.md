...
```
pytest            ●●●●●  юнит · параметризация · фикстуры · моки · покрытие
Интеграционные    ●●●●○  testcontainers · тестовая БД · контрактные тесты API
...
- ✅ **Покрыла стек тестами**: pytest на бэкенде, Jest на фронтенде; code review, Scrum
...
- 🔬 **Построила веб-инструменты анализа производительности ПО и железа**: Python 3.6–3.9 (Django 2.0–4.0), React 16, D3.js
- 🗃 **Отдала данные через REST API**: PostgreSQL 9.6–13 и MongoDB 4.x, дашборды на больших выборках
- 🧪 **Автоматизировала QA** (pytest, unittest) и мониторинг в Grafana / Prometheus
...
**Открыта к ролям:** Lead Developer / Team Lead · Senior Backend (Python / Go) · Senior FullStack · Senior Frontend (React / Vue)
